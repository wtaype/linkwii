import{t as e}from"./vendor-CdV9uUFu.js";import{n as t,o as n,s as r,t as i}from"./wii-B3ryywzw.js";function a(){let e=new Date;return`
  <footer class="foo wb txc psa">
    <span>Creado con <i class="fas fa-heart"></i> by <a class="ftx lkme" href="${r}" target="_blank">${t}</a></span>
    <span>${n} - <span class="wty">${e.getFullYear()}</span></span>
    <span class="abw"> | ${i} v13 | actualizado:
    <span class="wtu">${e.toLocaleString()}</span></span>
  </footer>
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/linkwii/v13/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`<div class="movil_divider"></div>${e(`.nv_right`).html()}`;e(`body`).append(`<div class="movil_overlay"></div>
