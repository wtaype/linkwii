import{t as e}from"./vendor-CdV9uUFu.js";import{b as t,h as n,l as r,m as i,n as a,o,p as s,x as c}from"./widev-D4VkqLj2.js";import{t as l}from"./wii-B3ryywzw.js";import{n as u}from"./rutas-tdiFKQiG.js";import{C as d,D as f,S as p,T as m,_ as h,a as g,f as _,g as v,i as y,l as b,m as x,p as S,u as C,v as w,w as T,x as E}from"./firebase-BFpKafW9.js";import{auth as D,db as O}from"./firebase-ClYlxPnb.js";var k={db:`smiles`,pagina:`rol`},A=`si`,j=`no`,M=`si`,N=`si`,P={smile:`/p/crear`,gestor:`/p/gestor`,empresa:`/p/empresa`,admin:`/p/admin`},F={"auth/email-already-in-use":`Email ya registrado`,"auth/weak-password":`Contraseña débil (mín. 6)`,"auth/invalid-credential":`Contraseña incorrecta`,"auth/invalid-email":`Email no válido`,"auth/missing-email":`Usuario no registrado`,"auth/too-many-requests":`Demasiados intentos`},I={regEmail:[e=>e.toLowerCase().trim(),e=>/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/.test(e)||`Email inválido`],regUsuario:[e=>e.toLowerCase().replace(/[^a-z0-9_]/g,``).trim(),e=>e.length>=4||`Mínimo 4 caracteres`],regNombre:[e=>e.trim(),e=>e.length>0||`Ingresa tu nombre`],regApellidos:[e=>e.trim(),e=>e.length>0||`Ingresa tus apellidos`],regPassword:[e=>e,e=>e.length>=6||`Mínimo 6 caracteres`],regPassword1:[e=>e,t=>t===e(`#regPassword`).val()||`No coinciden`]},L=(e,t,n,r,i=!1)=>`<div class="wilg_grupo"><i class="fas fa-${e}"></i><input type="${t}" id="${n}" placeholder="${r}" autocomplete="off">${i?`<i class="fas fa-eye wilg_ojo"></i>`:``}</div>`,R=(e=`smile`)=>e===`smile`?`
    ...
    <div class="wilg_head">
      <div class="wilg_logo"><img src="/linkwii/v13/smile.avif" alt="${l}"></div>
    ...
    <div class="wilg_head">
      <div class="wilg_logo wilg_logo_sm"><img src="/linkwii/v13/smile.avif" alt="${l}"></div>
