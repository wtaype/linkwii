import{t as e}from"./vendor-CdV9uUFu.js";import{a as t,i as n,p as r,x as i}from"./widev-lg4mTS5a.js";import{t as a}from"./wii-Du_Ge_Nq.js";import{n as o}from"./rutas-BoIljgUJ.js";import{a as s,f as c,g as l,l as u,m as d,n as f,o as p,p as m,u as h}from"./firebase-D8eePon0.js";import{auth as g,db as _}from"./firebase-nDyLaAcI.js";var v=[],y=null,b=null,x=null,S=`wi_notas_cache`,C=`wi_notas_cache_time`,w=100,T=1200,E=300*1e3,D=()=>r(`wiSmile`)||{},O=e=>{try{localStorage.setItem(S,JSON.stringify(e)),localStorage.setItem(C,Date.now().toString())}catch{}},k=()=>{try{return JSON.parse(localStorage.getItem(S)||`[]`)}catch{return[]}},A=()=>{let e=parseInt(localStorage.getItem(C)||`0`);return Date.now()-e<E},j=()=>{localStorage.removeItem(S),localStorage.removeItem(C)},M=[{id:`Cielo`,hex:`#0EBEFF`,bg:`rgba(14,190,255,.12)`,tx:`var(--tx)`,rgb:`14,190,255`},{id:`Dulce`,hex:`#FF5C93`,bg:`rgba(255,92,147,.12)`,tx:`var(--tx)`,rgb:`255,92,147`},{id:`Paz`,hex:`#10B981`,bg:`rgba(16,185,129,.12)`,tx:`var(--tx)`,rgb:`16,185,129`},{id:`Mora`,hex:`#8B5CF6`,bg:`rgba(139,92,246,.12)`,tx:`var(--tx)`,rgb:`139,92,246`},{id:`Sol`,hex:`#F59E0B`,bg:`rgba(245,158,11,.12)`,tx:`var(--tx)`,rgb:`245,158,11`}],N=()=>{let e=D();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email||g.currentUser?.email||``;return`
