import{t as e}from"./vendor-BDh6mtVu.js";import{h as t,i as n,m as r}from"./widev-CwEfqxZK.js";import{t as i}from"./wii-hgYUGqM9.js";import{f as a,l as o,m as s,r as c}from"./firebase-BzxEF9v7.js";import{db as l}from"./firebase-Be0frFSh.js";var u=()=>r(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
  ...
  </div>`},g=async()=>{let t=u();!t||t.rol!==`admin`||(e(document).off(`.am`),v(),y(),e(document).on(`click.am`,`#am_btn_refresh`,function(){let t=e(this).find(`i`).addClass(`fa-spin`);y(!0).then(()=>{setTimeout(()=>t.removeClass(`fa-spin`),500)})}))},_=()=>{e(document).off(`.am`)};function v(){e(`#am_n_total`).text(r(d)||`—`),e(`#am_n_pro`).text(r(f)||`—`),e(`#am_n_org`).text(r(p)||`—`),e(`#am_n_les`).text(r(m)||`45`)}async function y(i=!1){try{let u=s(l,`smiles`);if(i||!r(d)){let n=(await c(u)).data().count;t(d,n),e(`#am_n_total`).text(n)}if(i||!r(f)){let n=(await c(o(u,a(`rol`,`in`,[`gestor`,`empresa`,`admin`])))).data().count;t(f,n),e(`#am_n_pro`).text(n)}if(i||!r(p)){let n=(await c(o(u,a(`rol`,`==`,`empresa`)))).data().count;t(p,n),e(`#am_n_org`).text(n)}i&&n(`Estadísticas sincronizadas`,`success`)}catch(e){console.error(`[Admin] Error cargando stats:`,e),i&&n(`Error sincronizando`,`error`)}}export{_ as cleanup,g as init,h as render};