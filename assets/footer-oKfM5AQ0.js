import{t as e}from"./vendor-CdV9uUFu.js";import{n as t,o as n,s as r,t as i}from"./wii-CfWM6qmV.js";function a(){let e=new Date;return`
  ...
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/linkwii/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`${e(`.nv_right`).html()}`;e(`body`).append(`<div class="movil_overlay"></div>
