...
`,i=()=>{e(`.cj_step`,null,{anim:`cj_anim`,stagger:100}),console.log(`💡 ${t} v9 · Cómo Funciona OK`)},a=()=>{console.log(`🧹 Consejos limpiado`)};export{a as cleanup,i as init,r as render};