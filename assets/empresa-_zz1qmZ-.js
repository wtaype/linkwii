const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/inicio-BMaHV_hz.css"])))=>i.map(i=>d[i]);
import{t as e}from"./vendor-CdV9uUFu.js";import{a as t,d as n,m as r,p as i,r as a,s as o,t as s,u as c}from"./widev-DUThRLxv.js";import"./wii-CfWM6qmV.js";import{t as l}from"./preload-helper-D4dQmxiB.js";import{a as u,c as d,f,l as p,o as m,p as h}from"./firebase-D8eePon0.js";import{db as g}from"./firebase-DQFXlIdH.js";var _=()=>i(`wiSmile`),v=`epTotalEmpleados`,y=`epTotalEquipos`,b=`epMetricas`,x=`epFeed`,S=async()=>{let e=_();if(!e)return`<div class="epd_page"><div class="epd_empty"><i class="fas fa-lock"></i><p>Sin sesión activa.</p></div></div>`;let n=a(e.nombres||e.nombre||`Administrador`),r=o(e.nombres||e.nombre||``),l=e.foto||null,u=s(e.empresa||`Linkwii`),d=i(v)??`—`,f=i(y)??`—`,p=i(b)||{wpm:`—`,cert:`—`};return`
  <div class="epd_page">
