...
`,i=()=>{e(`.ej_card`,null,{anim:`ej_anim`,stagger:80}),console.log(`✨ ${t} v9 · Ejemplos OK`)},a=()=>{console.log(`🧹 Ejemplos limpiado`)};export{a as cleanup,i as init,r as render};