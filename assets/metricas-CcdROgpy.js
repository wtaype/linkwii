import{p as e}from"./widev-DUThRLxv.js";import{C as t,b as n,g as r,w as i}from"./firebase-CZPW4YtK.js";import{db as a}from"./firebase-D3Nw5WLI.js";var o=async()=>`
  ...
  `,s=async()=>{let o=e(`wiSmile`);if(o)try{let e=await r(n(i(a,`linkwiis`),t(`usuario`,`==`,o.usuario))),s=0,c=0,l=[];e.forEach(e=>{let t=e.data(),n=t.vistas||0,r=t.links?t.links.filter(e=>e.url||e.titulo).length:0;s+=n,c+=r,l.push({slug:e.id,vistas:n,linksCount:r,logo:t.logo})}),l.sort((e,t)=>t.vistas-e.vistas);let u=`
