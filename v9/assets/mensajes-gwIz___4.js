import{t as e}from"./vendor-BDh6mtVu.js";import{C as t,a as n,i as r,p as i,x as a}from"./widev-BTrgq3ZK.js";import{t as o}from"./wii-hgYUGqM9.js";import{n as s}from"./rutas-CEpg4Y3f.js";import{a as c,f as l,g as u,l as d,m as f,n as p,o as m,p as h,u as g}from"./firebase-Bp9Uq4pV.js";import{auth as _,db as v}from"./firebase-DhdZ2PmB.js";var y=[],b=null,x=!1,S=null,C=null,w=`wi_mensajes_cache`,T=50,E=()=>i(`wiSmile`)||{},D=e=>{try{localStorage.setItem(w,JSON.stringify(e))}catch{}},O=()=>{try{return JSON.parse(localStorage.getItem(w)||`[]`)}catch{return[]}},k=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},A=()=>{let e=E();if(!e.email)return location.replace(`/`),``;let t=e.nombre||e.usuario||e.email||_.currentUser?.email||``;return`
