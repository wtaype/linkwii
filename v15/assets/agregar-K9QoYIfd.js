import{t as e}from"./vendor-CdV9uUFu.js";import{b as t,i as n,p as r,x as i}from"./widev-CuyrBATB.js";import{a,f as o,g as s,l as c,m as l,n as u,p as d,t as f}from"./firebase-BFpKafW9.js";import{auth as p,db as m}from"./firebase-CgdV6sAi.js";var h=`wiAudios`,g=`wiImg`,_=()=>r(`wiSmile`)?.email||p.currentUser?.email||``,v=async e=>{let t=_();return t?(await a(c(d(m,e),o(`email`,`==`,t)))).docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>(t.creado?.seconds||0)-(e.creado?.seconds||0)):[]},y=async(e,t,n)=>{let r=_();return r?(await f(d(m,e),{email:r,titulo:t,src:n,creado:s(),actualizado:s()})).id:null},b=async(e,t)=>{await u(l(m,e,t))},x=()=>v(h),S=()=>v(g),C=(e,t)=>`
